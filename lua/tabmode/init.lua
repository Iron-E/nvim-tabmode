...
local _move_left       = {'b', 'j', 'h', to_char('<Left>')}
local _move_right      = {'w', 'k', 'l', to_char('<Right>')}
local _shift_left      = {'B', 'J', 'H', to_char('<S-Left>')}
local _shift_right     = {'W', 'K', 'L', to_char('<S-Right>')}
